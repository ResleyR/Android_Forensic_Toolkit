...
/*    public static void hexForArray(byte[] a, javax.swing.JTextArea c,int address) throws  EncodingAlgorithmException {
        HexadecimalEncodingAlgorithm hea = new  HexadecimalEncodingAlgorithm();
        Object o;
        StringBuffer s = new StringBuffer(8192);
        o = hea.decodeFromBytes(a, 0, a.length);
        hea.convertToCharacters(o, s);
...
//            if(i%8==0)
//                c.append("\t");
//            c.append(s.substring(i++, i++)+"\t");
//            System.out.println("i "+i);
//                   
//        }
//        c.append(String.format("\n%07X\t", address)+s.toString().replaceAll("................................(?=.)", String.format("\n%07X\t$0", address++)).replaceAll("..(?=.)", "$0\t"));
          c.append(s.toString().replaceAll("..(?=.)", "$0\t"));
    }
    * 
    */
}
